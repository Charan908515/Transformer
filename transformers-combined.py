...
class TransformerBlock(tf.keras.layers.Layer):
    def _init_(self, d_model, num_heads, dff, dropout_rate=0.1):
...
class Encoder(tf.keras.layers.Layer):
    def _init_(self, num_layers, d_model, num_heads, dff, input_vocab_size, maximum_position_encoding, dropout_rate=0.1):
...
class Decoder(tf.keras.layers.Layer):
    def _init_(self, num_layers, d_model, num_heads, dff, target_vocab_size, maximum_position_encoding, dropout_rate=0.1):
